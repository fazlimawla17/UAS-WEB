        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">
                    <a href="../admin" class="no-decoration text-muted"><i class="fas fa-home"></i> Home
                    </a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">
                    Kategori
        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <?php
                if(isset($_POST['tambah_kategori'])){
                    ...
                    $queryExist = mysqli_query($con, "SELECT nama FROM kategori 
                    WHERE nama='$kategori'");
                    ...
                    if($jumlahDataKategoriBaru > 0){
                        ...
                        <div class="alert alert-warning" role="alert">
                            Kategori yang anda masukkan sudah ada!
                        </div>
                        <?php
                    }
                    else{
